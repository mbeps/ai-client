 ...
 * @param user Recipient identity reference.
 * @param url Time-bound reset URL generated by Better Auth.
 * @returns Postmark send promise that resolves when the message is queued.
 */
