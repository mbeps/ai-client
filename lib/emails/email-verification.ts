...
/**
 * Sends the Better Auth email verification message through Postmark.
 * @param user Recipient identity details provided by Better Auth.
 * @param url Verification link generated by Better Auth hooks.
 */
