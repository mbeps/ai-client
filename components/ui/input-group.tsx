...
/**
 * Compound container that groups an input with inline prefix or suffix addons.
...
/**
 * Prefix or suffix decoration element attached to an `InputGroup`.
 * Focuses the sibling input when clicked (unless a button inside it is the target).
...
/**
 * Compact button styled for placement inside an `InputGroup`.
 * Strips the default button shadow and fits within the group border radius.
