...
export function SkillCard({ skill }: SkillCardProps) {
  ...
  return (
    <Link
      href={ROUTES.SETTINGS.SKILLS.detail(skill.id)}
      className="group block h-full focus-visible:outline-none"
    >
      <Card className="flex h-full min-h-[120px] cursor-pointer flex-col justify-between p-4 transition-colors hover:bg-muted/50">
